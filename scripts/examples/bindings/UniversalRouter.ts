...
export interface UniversalRouterInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "execute(bytes,bytes[])", values: [BytesLike, BytesLike[]]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "execute(bytes,bytes[],uint256)", data: BytesLike): Result;
...
export interface UniversalRouter extends BaseContract {
  ...
  collectRewards: TypedContractMethod<[looksRareClaim: BytesLike], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[commands: BytesLike, inputs: BytesLike[]], [void], "payable">;
  getFunction(
    nameOrSignature: "execute(bytes,bytes[],uint256)",
  ): TypedContractMethod<[commands: BytesLike, inputs: BytesLike[], deadline: BigNumberish], [void], "payable">;
  getFunction(
  ...
  getEvent(
    key: "RewardsSent",
  ): TypedContractEvent<RewardsSentEvent.InputTuple, RewardsSentEvent.OutputTuple, RewardsSentEvent.OutputObject>;
