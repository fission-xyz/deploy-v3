...
import type { UniversalRouter, UniversalRouterInterface, RouterParametersStruct } from "../UniversalRouter";
...
export class UniversalRouter__factory {
  ...
  static connect(address: string, runner?: ContractRunner | null): UniversalRouter {
