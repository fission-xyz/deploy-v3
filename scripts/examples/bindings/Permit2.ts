...
export declare namespace IAllowanceTransfer {
  ...
  export type TokenSpenderPairStructOutput = [token: string, spender: string] & { token: string; spender: string };
  ...
  export type PermitDetailsStructOutput = [token: string, amount: bigint, expiration: bigint, nonce: bigint] & {
    token: string;
    amount: bigint;
    expiration: bigint;
    nonce: bigint;
  ...
  export type AllowanceTransferDetailsStructOutput = [from: string, to: string, amount: bigint, token: string] & {
    from: string;
    to: string;
    amount: bigint;
    token: string;
...
export declare namespace ISignatureTransfer {
  ...
  export type SignatureTransferDetailsStructOutput = [to: string, requestedAmount: bigint] & {
    to: string;
...
export interface Permit2Interface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "Approval" | "Lockdown" | "NonceInvalidation" | "Permit" | "UnorderedNonceInvalidation",
  ): EventFragment;
...
export namespace ApprovalEvent {
  ...
  export type OutputTuple = [owner: string, token: string, spender: string, amount: bigint, expiration: bigint];
...
export namespace LockdownEvent {
  export type InputTuple = [owner: AddressLike, token: AddressLike, spender: AddressLike];
...
export namespace NonceInvalidationEvent {
  ...
  export type OutputTuple = [owner: string, token: string, spender: string, newNonce: bigint, oldNonce: bigint];
  export interface OutputObject {
    owner: string;
    token: string;
    spender: string;
...
export namespace UnorderedNonceInvalidationEvent {
  export type InputTuple = [owner: AddressLike, word: BigNumberish, mask: BigNumberish];
...
export interface Permit2 extends BaseContract {
  ...
  approve: TypedContractMethod<
    [token: AddressLike, spender: AddressLike, amount: BigNumberish, expiration: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  invalidateUnorderedNonces: TypedContractMethod<[wordPos: BigNumberish, mask: BigNumberish], [void], "nonpayable">;

  lockdown: TypedContractMethod<[approvals: IAllowanceTransfer.TokenSpenderPairStruct[]], [void], "nonpayable">;

  nonceBitmap: TypedContractMethod<[arg0: AddressLike, arg1: BigNumberish], [bigint], "view">;

  "permit(address,((address,uint160,uint48,uint48)[],address,uint256),bytes)": TypedContractMethod<
    [owner: AddressLike, permitBatch: IAllowanceTransfer.PermitBatchStruct, signature: BytesLike],
    [void],
    "nonpayable"
  >;

  "permit(address,((address,uint160,uint48,uint48),address,uint256),bytes)": TypedContractMethod<
    [owner: AddressLike, permitSingle: IAllowanceTransfer.PermitSingleStruct, signature: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[token: AddressLike, spender: AddressLike, newNonce: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "invalidateUnorderedNonces",
  ): TypedContractMethod<[wordPos: BigNumberish, mask: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "lockdown",
  ): TypedContractMethod<[approvals: IAllowanceTransfer.TokenSpenderPairStruct[]], [void], "nonpayable">;
  getFunction(
  ...
  ): TypedContractMethod<[transferDetails: IAllowanceTransfer.AllowanceTransferDetailsStruct[]], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "transferFrom(address,address,uint160,address)",
  ): TypedContractMethod<
    [from: AddressLike, to: AddressLike, amount: BigNumberish, token: AddressLike],
  ...
  getEvent(
    key: "Lockdown",
  ): TypedContractEvent<LockdownEvent.InputTuple, LockdownEvent.OutputTuple, LockdownEvent.OutputObject>;
  getEvent(
  ...
  getEvent(
    key: "Permit",
  ): TypedContractEvent<PermitEvent.InputTuple, PermitEvent.OutputTuple, PermitEvent.OutputObject>;
  getEvent(
